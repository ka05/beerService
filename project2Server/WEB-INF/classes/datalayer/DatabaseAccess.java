...
//    rsmd.close();
      ...
      while(rs.next()) 
      {
         ...
         for (int i=1; i<=colCount; i++){
            ...
            //System.out.println("rs.getString():" + rs.getString(i));   
         }
         rv.add(row); 
      }
...
//    rsmd.close();
 ...
 /**
   ...
   */  
   ...
   public boolean nonSelectResults(String sql, ArrayList<String> params) throws SQLException {
      PreparedStatement pstmt = parseSql(sql,params);
    ...
    public int getDataPQNumRows (String sql, ArrayList<String> params) throws SQLException {
      PreparedStatement pstmt = parseSql(sql,params);
      ResultSet rs = pstmt.executeQuery(); 
      
      ResultSetMetaData rsmd = rs.getMetaData();
      rs.next();
      int colCount = Integer.parseInt(rs.getString(1));
